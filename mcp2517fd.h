...
class mcp2517fd {
  public:
    ...
    */
    ...
    void ModuleEventEnable(CAN_MODULE_EVENT flags);
    ...
    */
    ...
    void TransmitChannelEventEnable(CAN_TX_FIFO_EVENT flags, CAN_FIFO_CHANNEL channel = CAN_FIFO_CH2);
    ...
    */
    ...
    void BitTimeConfigure(CAN_BITTIME_SETUP bitTime, CAN_SSP_MODE sspMode, CAN_SYSCLK_SPEED clk);
    ...
    {
      if(dlc<16) return DLC_DataLength[dlc];
      return -1;
    }
    // *****************************************************************************
